...
public abstract class Character extends Entity {
    ...
    protected Character(int energy, int id, XY coordinate, Color entityColor, Color entityTextColor, String name) {
        super(energy, id, coordinate, entityColor, entityTextColor, name);
    }
