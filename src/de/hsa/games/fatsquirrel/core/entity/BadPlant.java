...
public class BadPlant extends Entity {
    ...
    private static final Color ENTITYCOLOR = Color.color(0, 0.2353, 0);
    private static final Color ENTITYTEXTCOLOR = Color.color(0, 0.7647, 0);
    private static final String defaultName = "BadPlant";
